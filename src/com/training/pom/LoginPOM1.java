...
public class LoginPOM1 {
	...
	/*
	 * @FindBy(xpath = "//*[@id='header']/div[2]/div/div/div/ul/li[3]/a/text()")
	 * //i[@class='sl sl-icon-power']---List
	 * //*[@id="header"]/div[2]/div/div/div/ul/li[3]/a/text() //div[@class='sidebar
	 * left']//descendant::ul[2]/li[2]/a/text() private WebElement userloglink;
	 */
